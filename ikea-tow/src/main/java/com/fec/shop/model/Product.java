...
public class Product {
	...
	public void toFile(String diypath) {
		...
		try {
			...
			if (assembledSize.length() >= 1) {
				writer.write("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">��װ��ߴ�</span></span><br />");
				writer.write("<span style=\"font-size:14px;\">" + assembledSize + "</span>");
			}
			if (keyFeatures.length() >= 15) {
				writer.write("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;line-height:40px;\">��Ҫ����</span></span><br />");
				writer.write("<span style=\"font-size:14px;\">" + keyFeatures + "</span>");
			}
			if (designer.length() >= 1 || designerThoughts.length() >= 1) {
				writer.write("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">���ʦ</span></span><br />");
			}
			...
			writer.write("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">��װ�ߴ������</span></span><br />");
			writer.write("<span style=\"font-size:14px;\">��װ��" + numberOfPackages + "</span><br />");
			if (numberOfPackages.equals("1"))
				writer.write("<span style=\"font-size:14px;\">" + productInformation + "</span><br /><br />");
			else
				writer.write("<span style=\"font-size:14px;\">�ߴ������������</span><br /><br />");
			if (environment.length() >= 1) {
				writer.write("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">������Ϣ</span></span><br />");
			...
			if (goodToKnow.length() >= 1) {
				writer.write("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">�����ʾ</span></span><br />");
				writer.write("<span style=\"font-size:14px;\">" + goodToKnow + "</span><br /><br />");
			}
			if (careInst.length() >= 1) {
				writer.write("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">����˵��</span></span><br />");
				writer.write("<span style=\"font-size:14px;\">" + careInst + "</span><br /><br />");
			}
			if (lowestPrice.length() >= 1) {
				writer.write("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">�ͼ۸��������</span></span><br />");
				writer.write("<span style=\"font-size:14px;\">" + lowestPrice + "</span><br /><br />");
			}
			if (custMaterials.length() >= 1) {
				writer.write("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">��Ʒ����</span></span><br />");
	...
	public StringBuilder getDescribtion() {
		...
		if (assembledSize.length() >= 1) {
			describtion
					.append("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">��װ��ߴ�</span></span><br />");
			describtion.append("<span style=\"font-size:14px;\">" + assembledSize + "</span>");
		}
		if (keyFeatures.length() >= 15) {
			describtion
					.append("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;line-height:40px;\">��Ҫ����</span></span><br />");
			describtion.append("<span style=\"font-size:14px;\">" + keyFeatures + "</span>");
		}
		if (designer.length() >= 1 || designerThoughts.length() >= 1) {
			describtion
					.append("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">���ʦ</span></span><br />");
		}
		if (designerThoughts.length() >= 1)
		...
		describtion
				.append("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">��װ�ߴ������</span></span><br />");
		describtion.append("<span style=\"font-size:14px;\">��װ��" + numberOfPackages + "</span><br />");
		if (numberOfPackages.equals("1"))
			describtion.append("<span style=\"font-size:14px;\">" + productInformation + "</span><br /><br />");
		else
			describtion.append("<span style=\"font-size:14px;\">�ߴ������������</span><br /><br />");
		if (environment.length() >= 1) {
			describtion
					.append("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">������Ϣ</span></span><br />");
		...
		if (goodToKnow.length() >= 1) {
			describtion
					.append("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">�����ʾ</span></span><br />");
			describtion.append("<span style=\"font-size:14px;\">" + goodToKnow + "</span><br /><br />");
		}
		if (careInst.length() >= 1) {
			describtion
					.append("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">����˵��</span></span><br />");
			describtion.append("<span style=\"font-size:14px;\">" + careInst + "</span><br /><br />");
		}
		if (lowestPrice.length() >= 1) {
			describtion
					.append("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">�ͼ۸��������</span></span><br />");
			describtion.append("<span style=\"font-size:14px;\">" + lowestPrice + "</span><br /><br />");
		}
		if (custMaterials.length() >= 1) {
			describtion
					.append("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">��Ʒ����</span></span><br />");
			describtion.append("<span style=\"font-size:14px;\">" + custMaterials + "</span><br /><br />");
		}
		// describtion.append("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">��װ�ߴ������</span></span><br />"+"\n");
		// describtion.append("<span style=\"font-family:simhei;\"><span style=\"font-size:24px;line-height:40px;\">��װ�ߴ������</span></span><br />"+"\n");
	...
	public void toCSV(String diypath) {
		...
		try {
			...
			writer.append("\"�˼Ҵ�" + productNameProdInfo + productTypeProdInfo + "[" + product_dian_id + "]�˼ҼҾ�" + "\"	50006298	\"" + category
